...
public class FCLMsgListAdapter extends BaseAdapter {
	 ...
	 * @param context传入上下文
	 */
	public FCLMsgListAdapter(Context context, ArrayList<String> list) {
	...
	public View getView(final int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			convertView = View.inflate(context, R.layout.lv_item_fcl_result, null);
